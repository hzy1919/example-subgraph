...
export class NewSubnameOwner extends ethereum.Event {
  get params(): NewSubnameOwner__Params {
    return new NewSubnameOwner__Params(this);
  }
}

export class NewSubnameOwner__Params {
  _event: NewSubnameOwner;

  constructor(event: NewSubnameOwner) {
    this._event = event;
  }
...
export class ENS extends ethereum.SmartContract {
  ...
  setSubnameOwner(node: Bytes, name: string, owner: Address): Bytes {
    let result = super.call(
      "setSubnameOwner",
      "setSubnameOwner(bytes32,string,address):(bytes32)",
      [
        ethereum.Value.fromFixedBytes(node),
...
export class SetSubnameOwnerCall extends ethereum.Call {
  get inputs(): SetSubnameOwnerCall__Inputs {
    return new SetSubnameOwnerCall__Inputs(this);
  }

  get outputs(): SetSubnameOwnerCall__Outputs {
    return new SetSubnameOwnerCall__Outputs(this);
  }
}

export class SetSubnameOwnerCall__Inputs {
  _call: SetSubnameOwnerCall;

  constructor(call: SetSubnameOwnerCall) {
    this._call = call;
  }
...
export class SetSubnameOwnerCall__Outputs {
  _call: SetSubnameOwnerCall;
...
export class SetSubnameRecordCall extends ethereum.Call {
  get inputs(): SetSubnameRecordCall__Inputs {
    return new SetSubnameRecordCall__Inputs(this);
  }

  get outputs(): SetSubnameRecordCall__Outputs {
    return new SetSubnameRecordCall__Outputs(this);
  }
}

export class SetSubnameRecordCall__Inputs {
  _call: SetSubnameRecordCall;

  constructor(call: SetSubnameRecordCall) {
    this._call = call;
  }
...
export class SetSubnameRecordCall__Outputs {
  _call: SetSubnameRecordCall;
